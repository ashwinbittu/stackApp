...
<div class="mainbody container-fluid">
    ...
    <a class="navbar-brand" href="${contextPath}/index">RADAMM CORP</a>
                            <i class="brand_network"><small><small>Stack App</small></small></i>
                        </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2022 <a href="#"  target="_blank" class="w3-hover-text-green"> radammcorp.com</a></p>
</footer>
